...
<p>Workshops take place on <b>Fridays from 10:00-12:00</b>, unless otherwise indicated. Please note the location of each workshop and that our <b>MEETING LOCATION HAS CHANGED</b>. In-person workshops will be held in <b>PSEL (Physical Sciences & Engineering Library) Seminar Room (room 1025)</b>. Whenever possible, we will make a Zoom option available. We fully expect there to be some growing pains as we work out how best to do this.</p>
